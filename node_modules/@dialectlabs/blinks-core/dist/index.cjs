...
var BlinkContainer = ({
  ...
  _react.useEffect.call(void 0, () => {
    _optionalChain([callbacks, 'optionalAccess', _46 => _46.onActionMount, 'optionalCall', _47 => _47(
      action,
      _nullishCoalesce(websiteUrl, () => ( action.url)),
      actionState.action
    )]);
  }, [action.id]);
  _react.useEffect.call(void 0, () => {
  ...
  const execute = async (component, params) => {
    ...
    try {
      ...
      const chain = async (signature) => {
        if (!_optionalChain([response, 'access', _48 => _48.links, 'optionalAccess', _49 => _49.next])) {
          dispatch({
            type: "FINISH" /* FINISH */,
        ...
        if (!nextAction || isPartialAction && !_optionalChain([selector, 'optionalCall', _50 => _50(nextAction)])) {
          dispatch({
            type: "FINISH" /* FINISH */,
            successMessage: response.message
          });
...
function useAction({
  ...
  _react.useEffect.call(void 0, () => {
    _optionalChain([action, 'optionalAccess', _51 => _51.setAdapter, 'call', _52 => _52(adapter)]);
  }, [action, adapter]);
...
exports.AbstractActionComponent = AbstractActionComponent; exports.Action = Action; exports.ActionConfig = ActionConfig; exports.ActionsRegistry = ActionsRegistry; exports.ActionsURLMapper = ActionsURLMapper; exports.BASELINE_ACTION_BLOCKCHAIN_IDS = BASELINE_ACTION_BLOCKCHAIN_IDS; exports.BASELINE_ACTION_VERSION = BASELINE_ACTION_VERSION; exports.BlinkContainer = BlinkContainer; exports.BlockchainIds = BlockchainIds; exports.ButtonActionComponent = ButtonActionComponent; exports.DEFAULT_SUPPORTED_BLOCKCHAIN_IDS = DEFAULT_SUPPORTED_BLOCKCHAIN_IDS; exports.DisclaimerType = DisclaimerType; exports.ExecutionType = ExecutionType; exports.FormActionComponent = FormActionComponent; exports.MAX_SUPPORTED_ACTION_VERSION = MAX_SUPPORTED_ACTION_VERSION; exports.MultiValueActionComponent = MultiValueActionComponent; exports.SingleValueActionComponent = SingleValueActionComponent; exports.checkSecurity = checkSecurity; exports.defaultActionSupportStrategy = defaultActionSupportStrategy; exports.getExtendedActionState = getExtendedActionState; exports.getExtendedInterstitialState = getExtendedInterstitialState; exports.getExtendedWebsiteState = getExtendedWebsiteState; exports.isBlockchainSupported = isBlockchainSupported; exports.isInterstitial = isInterstitial; exports.isParameterSelectable = isParameterSelectable; exports.isPatternAllowed = isPatternAllowed; exports.isVersionSupported = isVersionSupported; exports.mergeActionStates = mergeActionStates; exports.proxify = proxify; exports.proxifyImage = proxifyImage; exports.setProxyUrl = setProxyUrl; exports.unfurlUrlToActionApiUrl = unfurlUrlToActionApiUrl; exports.useAction = useAction; exports.useActionsRegistryInterval = useActionsRegistryInterval;
